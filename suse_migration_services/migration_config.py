...
class MigrationConfig:
    ...
    **Implements reading of migration configuration file:**
    ...
    def get_zypper_migrate_args(self):
        """
        Return list of custom zypper arguments for the migrate scope
        """
        return self.config_data.get('zypper', {}).get('migrate', [])

    def get_zypper_install_args(self):
        """
        Return list of custom zypper arguments for the install scope
        """
        return self.config_data.get('zypper', {}).get('install', [])
