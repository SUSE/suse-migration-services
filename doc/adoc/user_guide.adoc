...
* The distribution migration system is focused on the main system meaning, if
  there are more systems mounted, the migration will only take those mounted
  under `root` system into account.
