...
class TestPreChecks():
    ...
    #subprocess.run 3x find + aa-status + rpm
    def test_check_lsm_migration(
        self, mock__apparmor_primitive_check, mock_exit, mock_open, mock_subprocess_run, mock_os_path_exists,
        mock_os_geteuid, mock_log
    ):
    ...
    def test_check_lsm_migration_simple(
        self, mock_exit, mock_open, mock_subprocess_run, mock_os_path_exists,
        mock_os_geteuid, mock_log
    ):
        find_retval = Mock()
